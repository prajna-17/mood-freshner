      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0c1a4c] via-[#1a3a8a] to-[#0e2260] text-white pt-20 pb-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          ...
          <p className="text-lg md:text-xl text-blue-100 leading-relaxed max-w-2xl mx-auto">
            ...
            products, delivery, or just want to say hi!
          </p>
        </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-blue-100">+91 88000 91914</p>
                    <p className="text-blue-100">+91 78959 59613</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-blue-100 leading-relaxed">
                      Village Taharpur, Bijnor (U.P.) - 246731
                    </p>
                  </div>
                </div>
              </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 text-gray-700"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto px-8 py-3 bg-orange-500 hover:bg-orange-600 disabled:opacity-70 text-white font-bold rounded-xl shadow-lg shadow-orange-500/30 transition-all flex items-center justify-center"
                >
                  {loading ? (
