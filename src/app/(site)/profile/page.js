			...
			>
				...
				>
					...
					<p className="text-xs text-amber-600 leading-relaxed">
						Select a package → Submit request → Pay the amount
						directly to the admin → Admin credits your coins.
						You'll see coins in your profile once approved.
					</p>
				</div>
				...
				{error && (
					<p className="text-xs text-red-500 font-bold mb-3 px-1">
						{error}
					</p>
				)}
				...
				<button
					...
					disabled={
						submitting || !finalAmount || finalAmount < 100
					}
		...
		<div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm px-5">
			...
			>
				...
				<p className="text-xs text-gray-400 font-medium mb-6">
					...
					to the admin. Coins will appear in your account once
					approved.
				</p>
				<button
					onClick={onClose}
					...
					>
						...
						>
							...
							<p className="text-[11px] font-bold text-amber-600">
								1 coin = ₹1 off at checkout · Use while
								placing orders
							</p>
						</div>
					</div>
